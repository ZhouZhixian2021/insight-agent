...
The analysis library admits evidence with consistent versions, locators and known hashes, counts independent works with usable evidence, and resolves supported Plan sections before dispatch. Below the approved work or full-text minimums, positive usable evidence can enter synthesis under continue_with_warning; stop_for_review and zero usable evidence block it. Warning admission never satisfies the early replenishment stop condition. The prompt discloses exact shortages, question gaps remain explicit, and reports display supporting-work shortages without allowing final delivery. The approved Brief and evidence integrity checks remain unchanged. Retrieval and full-text parsing remain unchanged.
