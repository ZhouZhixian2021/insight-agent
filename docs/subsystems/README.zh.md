...
| 页面 | 负责内容 |
|---|---|
| [academic-insight.md](academic-insight.zh.md) | 提供方无关的学术成果与版本标识、版本化 Research Brief、证据记录、六分区 Evidence Card 和不可变证据快照 |
| [academic-source.md](academic-source.zh.md) | 学术来源 seam：`AcademicSourceSearchRequest`/`Result`、`AcademicSourceWork`、提供方可用性与 `AcademicSourceError` |
